...
def set_own_cell_by_coord(coord, kind):
    ...
    # Colores mejorados
    if kind == "own_ship":
        own_canvas.itemconfig(rect, fill='#ffd700')  # Amarillo oro
    elif kind == "hit":
        own_canvas.itemconfig(rect, fill='#ff0000')  # Rojo brillante
    elif kind == "miss":
        own_canvas.itemconfig(rect, fill='#87ceeb')  # Azul cielo
    else:
...
def set_enemy_cell_by_coord(coord, kind):
    ...
    # Colores mejorados
    if kind == "hit":
        enemy_canvas.itemconfig(rect, fill='#ff0000')  # Rojo brillante
    elif kind == "miss":
        enemy_canvas.itemconfig(rect, fill='#87ceeb')  # Azul cielo
    else:
